...
static void wave_import_exact_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL phiL CCTK_ATTRIBUTE_UNUSED = phiExactL;
    
    CCTK_REAL piL CCTK_ATTRIBUTE_UNUSED = piExactL;
    /* Copy local copies back to grid functions */
    phi[index] = phiL;
    pi[index] = piL;
  }
...
extern "C" void wave_import_exact(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    "Wave::evolved",
    "Wave::exact"};
  AssertGroupStorage(cctkGH, "wave_import_exact", 2, groups);
  ...
  LoopOverEverything(cctkGH, wave_import_exact_Body);
  if (verbose > 1)
  {
