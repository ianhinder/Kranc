...
static void calc_rhs_2_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const imin[3], int const imax[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL /*const*/ PDstandard2th11phi CCTK_ATTRIBUTE_UNUSED  = PDstandard2th11(&phi[index]);
    CCTK_REAL /*const*/ PDstandard2th22phi CCTK_ATTRIBUTE_UNUSED  = PDstandard2th22(&phi[index]);
    CCTK_REAL /*const*/ PDstandard2th33phi CCTK_ATTRIBUTE_UNUSED  = PDstandard2th33(&phi[index]);
    
    /* Calculate temporaries and grid functions */
    CCTK_REAL CCTK_ATTRIBUTE_UNUSED phirhsL = piL;
    
    CCTK_REAL CCTK_ATTRIBUTE_UNUSED pirhsL = PDstandard2th11phi + 
