...
static void wave_calc_norm_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL VL2squared CCTK_ATTRIBUTE_UNUSED = SQR(phiL) + SQR(piL);
    
    CCTK_REAL VL2L CCTK_ATTRIBUTE_UNUSED = sqrt(VL2squared);
    
    CCTK_REAL VDPsquared CCTK_ATTRIBUTE_UNUSED = SQR(piL) + 
      SQR(PDplus1phi) + SQR(PDplus2phi) + SQR(PDplus3phi);
    
    CCTK_REAL VDPL CCTK_ATTRIBUTE_UNUSED = sqrt(VDPsquared);
    
    CCTK_REAL EL2squared CCTK_ATTRIBUTE_UNUSED = SQR(phiErrorL) + 
      SQR(piErrorL);
    
    CCTK_REAL EL2L CCTK_ATTRIBUTE_UNUSED = sqrt(EL2squared);
