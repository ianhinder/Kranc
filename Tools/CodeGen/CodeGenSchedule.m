...
applyAfterRules[sf_,rules_] := Module[{myrules,rq,pg,ap,aps,sfn,is},
  ...
  (* My rules can contain multiple and or duplicate rules for the same variable. Fix this. *)
  ...
  *)
  ap = DeleteDuplicates[
    Map[(# /. Dep[dep_] :> dep)&,
    Select[Flatten[rq /. mergeRules[myrules]],MatchQ[#,Dep[_]]&]]];
