...
static void eulersr_cons_calc_flux_2_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    const CCTK_REAL ShiftMinus2epsiRight CCTK_ATTRIBUTE_UNUSED = ShiftMinus2(&epsiRight[index]);
    ...
    const CCTK_REAL ShiftMinus2tauRight CCTK_ATTRIBUTE_UNUSED = ShiftMinus2(&tauRight[index]);
    const CCTK_REAL ShiftMinus2v2Right CCTK_ATTRIBUTE_UNUSED = ShiftMinus2(&v2Right[index]);
    /* Calculate temporaries and grid functions */
    CCTK_REAL DenFluxLeft CCTK_ATTRIBUTE_UNUSED = DenLeftL*v2LeftL;
    ...
    CCTK_REAL S1FluxLeft CCTK_ATTRIBUTE_UNUSED = S1LeftL*v2LeftL;
    ...
    CCTK_REAL S2FluxLeft CCTK_ATTRIBUTE_UNUSED = S2LeftL*v2LeftL + 
      epsiLeftL*rhoLeftL*(-1 + gamma);
    
    CCTK_REAL S2FluxRight CCTK_ATTRIBUTE_UNUSED = (-1 + 
      gamma)*ShiftMinus2epsiRight*ShiftMinus2rhoRight + 
    ...
    CCTK_REAL S3FluxLeft CCTK_ATTRIBUTE_UNUSED = S3LeftL*v2LeftL;
    ...
    CCTK_REAL tauFluxLeft CCTK_ATTRIBUTE_UNUSED = v2LeftL*(tauLeftL + 
      epsiLeftL*rhoLeftL*(-1 + gamma));
    
    CCTK_REAL tauFluxRight CCTK_ATTRIBUTE_UNUSED = ((-1 + 
      gamma)*ShiftMinus2epsiRight*ShiftMinus2rhoRight + 
      ShiftMinus2tauRight)*ShiftMinus2v2Right;
    
    CCTK_REAL tauFluxL CCTK_ATTRIBUTE_UNUSED = 0.5*(hlleAlpha*(-tauLeftL + 
      ShiftMinus2tauRight) + tauFluxLeft + tauFluxRight);
    /* Copy local copies back to grid functions */
...
extern "C" void eulersr_cons_calc_flux_2(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "EulerSR::v2_lr_group"};
  AssertGroupStorage(cctkGH, "eulersr_cons_calc_flux_2", 13, groups);
  
  EnsureStencilFits(cctkGH, "eulersr_cons_calc_flux_2", 1, 1, 1);
  
  LoopOverInterior(cctkGH, eulersr_cons_calc_flux_2_Body);
  if (verbose > 1)
  {
