...
*)
  ...
  Switch[where, 
    ...
    PenaltyPrim2Char, DefineFunction[functionName, "CCTK_INT", 
               "CCTK_POINTER_TO_CONST const cctkGH_, CCTK_INT const dir, CCTK_INT const face, CCTK_REAL const * restrict const base_, CCTK_INT const * restrict const lbnd, CCTK_INT const * restrict const lsh, CCTK_INT const * restrict const lssh, CCTK_INT const rhs_flag, CCTK_INT const num_modes, CCTK_POINTER const * restrict const modes, CCTK_POINTER const * restrict const speeds", 
    ...
    CommentedBlock["Check for nans",
                   Join[{"if (\n"},
                        ...
                        {"    0)\n",
                         ...
                         "  CCTK_VInfo(CCTK_THORNSTRING, \"lssh: %d %d %d\", cctk_lssh[CCTK_LSSH_IDX(0,0)], cctk_lsh[CCTK_LSSH_IDX(0,1)], cctk_lsh[CCTK_LSSH_IDX(0,2)]);\n",
