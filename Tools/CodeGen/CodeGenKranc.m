    ...
    "Initialise finite differencing variables",
    {
      ...
      Apply[DeclareAssignVariable,
            {{"ptrdiff_t", "di", "1"},
             ...
             {"ptrdiff_t", "cctkLbnd1", "cctk_lbnd[0]"},
             {"ptrdiff_t", "cctkLbnd2", "cctk_lbnd[1]"},
             {"ptrdiff_t", "cctkLbnd3", "cctk_lbnd[2]"},
             {DataType[], "t", "ToReal(cctk_time)"},
             {DataType[], "cctkOriginSpace1", "ToReal(CCTK_ORIGIN_SPACE(0))"},
             {DataType[], "cctkOriginSpace2", "ToReal(CCTK_ORIGIN_SPACE(1))"},
             {DataType[], "cctkOriginSpace3", "ToReal(CCTK_ORIGIN_SPACE(2))"},
