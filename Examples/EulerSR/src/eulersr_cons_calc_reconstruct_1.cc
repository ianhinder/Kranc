...
static void eulersr_cons_calc_reconstruct_1_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    const CCTK_REAL DiffPlus1epsi CCTK_ATTRIBUTE_UNUSED = DiffPlus1(&epsi[index]);
    const CCTK_REAL DiffMinus1epsi CCTK_ATTRIBUTE_UNUSED = DiffMinus1(&epsi[index]);
...
extern "C" void eulersr_cons_calc_reconstruct_1(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "EulerSR::v3_lr_group",
    "EulerSR::v_group"};
  AssertGroupStorage(cctkGH, "eulersr_cons_calc_reconstruct_1", 8, groups);
  
  EnsureStencilFits(cctkGH, "eulersr_cons_calc_reconstruct_1", 1, 1, 1);
  
  LoopOverInterior(cctkGH, eulersr_cons_calc_reconstruct_1_Body);
  if (verbose > 1)
  {
