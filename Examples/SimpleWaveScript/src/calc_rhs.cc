...
extern "C" void calc_rhs_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "SimpleWaveScript::phi_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for SimpleWaveScript::phi_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "SimpleWaveScript::pi_grouprhs","flat");
  if (ierr < 0)
...
extern "C" void calc_rhs(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "SimpleWaveScript::phi_grouprhs",
    "SimpleWaveScript::pi_group",
    "SimpleWaveScript::pi_grouprhs"};
  ...
  switch (fdOrder)
  {
    ...
    case 4:
    {
      EnsureStencilFits(cctkGH, "calc_rhs", 2, 2, 2);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
