...
extern "C" void Laplace_initial_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  if (cctk_iteration % Laplace_initial_calc_every != Laplace_initial_calc_offset)
    return;
...
static void Laplace_initial_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL phiL CCTK_ATTRIBUTE_UNUSED = 
...
extern "C" void Laplace_initial(CCTK_ARGUMENTS)
{
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering Laplace_initial_Body");
  }
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving Laplace_initial_Body");
  }
}
