...
static void wave_calc_errors_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL phiExactL CCTK_ATTRIBUTE_UNUSED = phiExact[index];
    CCTK_REAL piL CCTK_ATTRIBUTE_UNUSED = pi[index];
    CCTK_REAL piExactL CCTK_ATTRIBUTE_UNUSED = piExact[index];
    ...
    CCTK_REAL phiErrorL CCTK_ATTRIBUTE_UNUSED = -phiExactL + phiL;
    
    CCTK_REAL piErrorL CCTK_ATTRIBUTE_UNUSED = -piExactL + piL;
    /* Copy local copies back to grid functions */
...
extern "C" void wave_calc_errors(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "Wave::evolved",
    "Wave::exact"};
  AssertGroupStorage(cctkGH, "wave_calc_errors", 3, groups);
  ...
  LoopOverEverything(cctkGH, wave_calc_errors_Body);
  if (verbose > 1)
  {
