...
DefFn[
  ...
  knownSymbols = Join[lookupDefault[cleancalc, AllowedSymbols, {}], gfs, shorts, parameters,
    {t,cctkOriginSpace1,cctkOriginSpace2,cctkOriginSpace3,dx,dy,dz,dt,idx,idy,idz, usejacobian, Pi, E, cctkLbnd1, cctkLbnd2, cctkLbnd3, Symbol["del"], Symbol["i"], Symbol["j"], Symbol["k"], Symbol["ti"], Symbol["tj"], Symbol["tk"], normal1, normal2,
    normal3, tangentA1, tangentA2, tangentA3, tangentB1, tangentB2, tangentB3},
    If[useJacobian, JacobianSymbols[], {}]];

  inherited = Intersection[allSymbols,OptionValue[InheritedVariables]];
  inheritedParams = Intersection[allSymbols,Map[(# /. Rule[from_,_]->from)&,
   OptionValue[InheritedParameters]]];
  ...
  unknownSymbols /.
    {{} :> True,
      {s_} :> ThrowError["Unknown symbol " <> ToString[s] <> " in calculation " <>
        GetCalculationName[cleancalc]],
      ss_ :> ThrowError["Unknown symbols " <> StringJoin[Riffle[ToString/@ss,", "]] <>
