...
extern "C" void calc_rhs_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "SimpleWaveODE::evolved_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for SimpleWaveODE::evolved_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "SimpleWaveODE::ode_grouprhs","flat");
  if (ierr < 0)
...
static void calc_rhs_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  CCTK_REAL bL CCTK_ATTRIBUTE_UNUSED = b[index];
  
  /* Calculate temporaries and arrays functions */
  CCTK_REAL arhsL CCTK_ATTRIBUTE_UNUSED = bL;
  
  CCTK_REAL brhsL CCTK_ATTRIBUTE_UNUSED = -aL;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL pirhsL CCTK_ATTRIBUTE_UNUSED = aL*(PDstandard2nd11phi + 
...
extern "C" void calc_rhs(CCTK_ARGUMENTS)
{
  ...
  AssertGroupStorage(cctkGH, "calc_rhs", 4, groups);
