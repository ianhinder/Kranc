...
static CCTK_REAL PDstandardfdOrder23_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder23_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder22_impl(u, p1o1, cdk, cdj);
}
#endif
...
static CCTK_REAL PDstandardfdOrder43_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder43_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder42_impl(u, p1o1, cdk, cdj);
}
#endif
...
static CCTK_REAL PDstandardfdOrder233_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder233_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder222_impl(u, p1o1, cdk, cdj);
}
#endif
...
static CCTK_REAL PDstandardfdOrder433_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder433_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder422_impl(u, p1o1, cdk, cdj);
}
#endif
...
static CCTK_REAL PDstandardfdOrder213_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder213_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder212_impl(u, p1o1, cdk, cdj);
}
#endif
...
static CCTK_REAL PDstandardfdOrder223_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder223_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return 0;
}
...
static CCTK_REAL PDstandardfdOrder231_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder231_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder212_impl(u, p1o1, cdk, cdj);
}
...
static CCTK_REAL PDstandardfdOrder232_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder232_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder223_impl(u, p1o1, cdj, cdk);
}
#endif
...
static CCTK_REAL PDstandardfdOrder413_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder413_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder412_impl(u, p1o1, cdk, cdj);
}
#endif
...
static CCTK_REAL PDstandardfdOrder423_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder423_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return 0;
}
...
static CCTK_REAL PDstandardfdOrder431_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder431_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder412_impl(u, p1o1, cdk, cdj);
}
...
static CCTK_REAL PDstandardfdOrder432_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk) CCTK_ATTRIBUTE_NOINLINE CCTK_ATTRIBUTE_UNUSED;
static CCTK_REAL PDstandardfdOrder432_impl(const CCTK_REAL* restrict const u, const CCTK_REAL p1o1, const ptrdiff_t cdj, const ptrdiff_t cdk)
{
  const ptrdiff_t cdi CCTK_ATTRIBUTE_UNUSED = sizeof(CCTK_REAL);
  return PDstandardfdOrder423_impl(u, p1o1, cdj, cdk);
}
#endif
