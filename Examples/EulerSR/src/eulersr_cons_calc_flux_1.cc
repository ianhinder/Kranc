...
static void eulersr_cons_calc_flux_1_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    const CCTK_REAL ShiftMinus1epsiRight CCTK_ATTRIBUTE_UNUSED = ShiftMinus1(&epsiRight[index]);
    ...
    const CCTK_REAL ShiftMinus1tauRight CCTK_ATTRIBUTE_UNUSED = ShiftMinus1(&tauRight[index]);
    const CCTK_REAL ShiftMinus1v1Right CCTK_ATTRIBUTE_UNUSED = ShiftMinus1(&v1Right[index]);
    /* Calculate temporaries and grid functions */
    CCTK_REAL DenFluxLeft CCTK_ATTRIBUTE_UNUSED = DenLeftL*v1LeftL;
    ...
    CCTK_REAL S1FluxLeft CCTK_ATTRIBUTE_UNUSED = S1LeftL*v1LeftL + 
      epsiLeftL*rhoLeftL*(-1 + gamma);
    
    CCTK_REAL S1FluxRight CCTK_ATTRIBUTE_UNUSED = (-1 + 
      gamma)*ShiftMinus1epsiRight*ShiftMinus1rhoRight + 
    ...
    CCTK_REAL S2FluxLeft CCTK_ATTRIBUTE_UNUSED = S2LeftL*v1LeftL;
    ...
    CCTK_REAL S3FluxLeft CCTK_ATTRIBUTE_UNUSED = S3LeftL*v1LeftL;
    ...
    CCTK_REAL tauFluxLeft CCTK_ATTRIBUTE_UNUSED = v1LeftL*(tauLeftL + 
      epsiLeftL*rhoLeftL*(-1 + gamma));
    
    CCTK_REAL tauFluxRight CCTK_ATTRIBUTE_UNUSED = ((-1 + 
      gamma)*ShiftMinus1epsiRight*ShiftMinus1rhoRight + 
      ShiftMinus1tauRight)*ShiftMinus1v1Right;
    
    CCTK_REAL tauFluxL CCTK_ATTRIBUTE_UNUSED = 0.5*(hlleAlpha*(-tauLeftL + 
      ShiftMinus1tauRight) + tauFluxLeft + tauFluxRight);
    /* Copy local copies back to grid functions */
...
extern "C" void eulersr_cons_calc_flux_1(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "EulerSR::v1_lr_group"};
  AssertGroupStorage(cctkGH, "eulersr_cons_calc_flux_1", 13, groups);
  
  EnsureStencilFits(cctkGH, "eulersr_cons_calc_flux_1", 1, 1, 1);
  
  LoopOverInterior(cctkGH, eulersr_cons_calc_flux_1_Body);
  if (verbose > 1)
  {
