...
extern "C" void EM_evol_SelectBCs(CCTK_ARGUMENTS)
{
  ...
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "EMScript::B_grouprhs","flat");
  if (ierr < 0)
    CCTK_WARN(1, "Failed to register flat BC for EMScript::B_grouprhs.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "EMScript::El_grouprhs","flat");
  if (ierr < 0)
...
static void EM_evol_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL PDstandard2B1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard3B1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard1B2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard3B2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard1B3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard2B3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard2El1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard3El1 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard1El2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard3El2 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard1El3 CCTK_ATTRIBUTE_UNUSED;
    CCTK_REAL PDstandard2El3 CCTK_ATTRIBUTE_UNUSED;
    ...
    CCTK_REAL El1rhsL CCTK_ATTRIBUTE_UNUSED = PDstandard2B3 - 
      PDstandard3B2;
    
    CCTK_REAL El2rhsL CCTK_ATTRIBUTE_UNUSED = -PDstandard1B3 + 
      PDstandard3B1;
    
    CCTK_REAL El3rhsL CCTK_ATTRIBUTE_UNUSED = PDstandard1B2 - 
      PDstandard2B1;
    
    CCTK_REAL B1rhsL CCTK_ATTRIBUTE_UNUSED = -PDstandard2El3 + 
      PDstandard3El2;
    
    CCTK_REAL B2rhsL CCTK_ATTRIBUTE_UNUSED = PDstandard1El3 - 
      PDstandard3El1;
    
    CCTK_REAL B3rhsL CCTK_ATTRIBUTE_UNUSED = -PDstandard1El2 + 
      PDstandard2El1;
    /* Copy local copies back to grid functions */
    B1rhs[index] = B1rhsL;
    B2rhs[index] = B2rhsL;
...
extern "C" void EM_evol(CCTK_ARGUMENTS)
{
  ...
  switch (fdOrder)
  {
    ...
    case 4:
    {
      EnsureStencilFits(cctkGH, "EM_evol", 2, 2, 2);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
