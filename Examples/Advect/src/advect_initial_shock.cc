...
static void advect_initial_shock_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL v1L CCTK_ATTRIBUTE_UNUSED = v0;
    
    CCTK_REAL v2L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL v3L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL rhoL CCTK_ATTRIBUTE_UNUSED = amp*StepFunction(-0.5 + xL);
    /* Copy local copies back to grid functions */
    rho[index] = rhoL;
    v1[index] = v1L;
    v2[index] = v2L;
...
extern "C" void advect_initial_shock(CCTK_ARGUMENTS)
{
  ...
  const char* const groups[] = {
    ...
    "Advect::rho_group",
    "Advect::v_group"};
  AssertGroupStorage(cctkGH, "advect_initial_shock", 3, groups);
  
  
  LoopOverEverything(cctkGH, advect_initial_shock_Body);
  if (verbose > 1)
  {
